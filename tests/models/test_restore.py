...
def test_dp_resume(tmpdir):
    ...
    trainer_options = dict(max_epochs=1, limit_train_batches=1, limit_val_batches=1, gpus=2, accelerator='dp', default_root_dir=tmpdir)
    ...
    def assert_good_acc():
        ...
        print("STAGE IS NOW", dp_model.module.module.running_stage)
